    ...
    const MOCK_DATA = {
        zones: [
            ...
            },
            {
                ...
                region: 'gran_asuncion',
                city: 'Lambaré',
                neighborhood: 'Valle Apu\'a & Av. Mcal. López',
                category: 'residential_mid',
                coordinates: [-25.3380, -57.6180],
        ...
        leads: [
            ...
            {
                id: 'lead-103',
                name: 'Esteban Rossi (Inversor Buenos Aires)',
...
_______________________________          _______________________________
    ...
    function initLocalStorage() {
        if (!localStorage.getItem(SUPABASE_CONFIG.storageKey)) {
